...
namespace TomiSoft.ProductCatalog.Client.OpenApiGenerated.Client
{
    /// <summary>
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        public ApiClient()
        {
            _baseUrl = TomiSoft.ProductCatalog.Client.OpenApiGenerated.Client.GlobalConfiguration.Instance.BasePath;
        }
